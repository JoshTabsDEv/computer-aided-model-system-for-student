    ...
    <x-student.section-div-style>
        ...
        <div class="container mx-auto p-4 uppercase -mb-8">
            <p class="mb-2 xl:text-3xl text-black font-bold">Welcome, <span
                    class="text-red-500">{{ $user->name }}</span>!</p>
                            ...
                            <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-4">
                                <div class="bg-white rounded-lg shadow-lg p-6 h-full">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-lg font-semibold text-gray-800">
                                                {{ $courseAssignment->course->course_code }}</div>
                                            <div class="text-sm text-gray-600">{{ $courseAssignment->teacher->name }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-grow">
                                    ...
                                    <div class="mt-4 flex justify-between items-center">
                                        ...
                                        <div>
                                            <a href="{{ route('student.student.index', ['userID' => auth()->user()->id, 'assignmentTableID' => $courseAssignment->id, 'courseID' => $courseAssignment->course->id]) }}"
                ...
                <div class="bg-white rounded-lg p-6 max-w-md mx-auto">
                    ...
                    <form action="{{ route('student.joinClass') }}" method="post">
                        ...
                        <input type="text" name="class_code" id="class_code"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline @error('course_code') is-invalid @enderror"
                            required autofocus>

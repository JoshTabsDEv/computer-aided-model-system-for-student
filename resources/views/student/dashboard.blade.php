...
<x-student-app-layout>
    ...
    <x-student.section-div-style>
        ...
        <div class="flex flex-wrap gap-4 mt-2">
            ...
            <div class="flex flex-col items-center justify-center w-full h-auto bg-gray-100 rounded-lg p-6 text-center">
                <div class="text-md text-black mb-4">
                    Currently not enrolled in any courses.
                </div>
                <div class="text-sm text-gray-600 mb-6">
                    <p>To find available courses and join new classes, please contact your adviser/instructor.</p>
                </div>
            </div>
            ...
            <div id="inviteCodeModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 opacity-0 pointer-events-none transition-opacity duration-500">
                <div class="bg-white rounded-lg p-6 max-w-md mx-auto">
                    ...
                    <form action="{{ route('student.joinClass') }}" method="post">
                        @csrf
                        <label for="class_code" class="block text-gray-700 text-md font-bold mb-2">Class Code:</label>
                        ...
                        <button id="closeModalBottom" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 w-full">Join</button>
                    </form>
                </div>
            </div>
            <button id="openModal" class="absolute bottom-4 right-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-base shadow-md">Add Class Code</button>
        </div>
    </x-student.section-div-style>
</x-student-app-layout>

<!-- Sidebar Toggle Script -->
<x-show-hide-sidebar toggleButtonId="toggleButton" sidebarContainerId="sidebarContainer" dashboardContentId="dashboardContent" toggleIconId="toggleIcon" />

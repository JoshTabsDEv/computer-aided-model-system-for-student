...
<?php $component = App\View\Components\UserRoutePageName::resolve(['routeName' => 'admin.program.index'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('program-show-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-410979142-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\Users\Joshua Tabura\Desktop\computer-aided-model-system-for-student\resources\views\admin\program\index.blade.php ENDPATH**/ ?>
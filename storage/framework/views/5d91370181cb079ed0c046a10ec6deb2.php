...
<?php endif; ?>
    ...
    <div class="flex justify-between mb-4 sm:-mt-4">
        <div class="font-bold text-md tracking-tight text-black mt-2">Admin / Manage Dean</div>
            <a href="<?php echo e(route('admin.dean.create')); ?>">
                <button class="bg-blue-500 text-white text-sm px-3 py-2 rounded hover:bg-blue-700">
                    <i class="fa-solid fa-plus fa-xs" style="color: #ffffff;"></i> Add Dean
                </button>
            </a>
        </div>
        ...
        <div class="overflow-x-auto">
            ...
            <?php else: ?>
                <table class="table-auto border-collapse border border-gray-400 w-full text-center mb-4">
                        ...
                        <tr>
                            ...
                            <th class="border border-gray-400 px-4 py-2">
                                <button wire:click="sortBy('dean_fullname')" class="w-full h-full flex items-center justify-center">
                                    Dean Full Name
                                    <?php if($sortField == 'dean_fullname'): ?>
                            ...
                            <th class="border border-gray-400 px-4 py-2">
                                <button wire:click="sortBy('department_id')" class="w-full h-full flex items-center justify-center">
                                    Assign Department
                                    <?php if($sortField == 'department_id'): ?>
                                        <?php if($sortDirection == 'asc'): ?>
                                            &nbsp;<i class="fa-solid fa-down-long fa-xs"></i>
                                            <?php else: ?>
                                            &nbsp;<i class="fa-solid fa-up-long fa-xs"></i> 
                    ...
                    <form id="deleteSelectedForm" action="<?php echo e(route('admin.dean.deleteSelected')); ?>" method="POST" onsubmit="return confirmDelete(event);">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <input type="hidden" wire:model="deleteAllClicked" value="true">
                    <tbody>
                        <?php $__currentLoopData = $deans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dean): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td  class="text-black border border-gray-400 px-4 py-2"><input type="checkbox" name="selected[]" value="<?php echo e($dean->id); ?>"></td>
                                <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($dean->dean_fullname); ?></td>
                                <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($dean->dean_status); ?></td>
                                <td class="text-black border border-gray-400 px-4 py-2"><?php echo e($dean->department->department_name); ?></td>
                                <td class="text-black border border-gray-400 px-4 py-2">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="<?php echo e(route('admin.dean.edit', $dean->id)); ?>" class="bg-blue-500 text-white text-sm px-3 py-2 rounded hover:bg-red-500">
...
<?php /**PATH C:\Users\Joshua Tabura\Desktop\computer-aided-model-system-for-student\resources\views\livewire\dean-show-table.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
    ...
    <div class="flex justify-between mb-4 sm:-mt-4">
        ...
        <div class="overflow-x-auto">
            <?php if($search && $departments->isEmpty()): ?>
                <p class="text-black mt-8 text-center">No department found for matching "<?php echo e($search); ?>"</p>
            <?php elseif(!$search && $departments->isEmpty()): ?>
            ...
            <?php else: ?>
                        ...
                        <tr>
                            ...
                            <th class="border border-gray-400 px-3 py-2">
                                <button wire:click="sortBy('department_name')" class="w-full h-full flex items-center justify-center">
                                    Dept Name
                                    <?php if($sortField == 'department_name'): ?>
                            ...
                            <th class="border border-gray-400 px-3 py-2">
                                <button wire:click="sortBy('department_description')" class="w-full h-full flex items-center justify-center">
                                    Dept Description
                                    <?php if($sortField == 'department_description'): ?>
                                        <?php if($sortDirection == 'asc'): ?>
                                            &nbsp;<i class="fa-solid fa-down-long fa-xs"></i>
                                        <?php else: ?>
                                            &nbsp;<i class="fa-solid fa-up-long fa-xs"></i>
                ...
                <form id="deleteSelectedForm" action="<?php echo e(route('admin.department.deleteSelected')); ?>" method="POST" onsubmit="return confirmDelete(event);">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Joshua Tabura\Desktop\computer-aided-model-system-for-student\resources\views\livewire\department-show-table.blade.php ENDPATH**/ ?>
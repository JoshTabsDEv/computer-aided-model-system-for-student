...
<?php $component->withAttributes([]); ?>
        ...
        <div class="container mx-auto p-4 uppercase -mb-8">
            <p class="mb-2 xl:text-3xl text-black font-bold">Welcome, <span
                    class="text-red-500"><?php echo e($user->name); ?></span>!</p>
                                ...
                                <div class="bg-white rounded-lg shadow-lg p-6 h-full">
                                    <div class="flex items-center mb-4">
                                        <div class="flex-shrink-0">
                                            <img class="h-12 w-12 rounded-full" src="https://via.placeholder.com/50"
                                                alt="Profile picture">
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-lg font-semibold text-gray-800">
                                                <?php echo e($courseAssignment->course->course_code); ?></div>
                                            <div class="text-sm text-gray-600"><?php echo e($courseAssignment->teacher->name); ?>
                                    ...
                                    <div class="mt-4 flex justify-between items-center">
                                        <div>
                                            <span
                                                class="inline-block bg-blue-200 text-blue-800 text-xs px-2 py-1 uppercase rounded-full">Active</span>
                                        </div>
                                        <div>
                                            <a href="<?php echo e(route('student.student.index', ['userID' => auth()->user()->id, 'assignmentTableID' => $courseAssignment->id, 'courseID' => $courseAssignment->course->id])); ?>"
                                                class="text-xs text-gray-500 hover:text-gray-700">Go to Class</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-lg p-6 max-w-md mx-auto">
                    ...
                    <form action="<?php echo e(route('student.joinClass')); ?>" method="post">
                        ...
                        <input type="text" name="class_code" id="class_code"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline <?php $__errorArgs = ['course_code'];
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <button id="closeModalBottom"
                            class="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 w-full">
                            Join
                        </button>
                    </form>
                </div>
            ...
            <button id="openModal"
                class="absolute bottom-4 right-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-base shadow-md">
                Add Class Code
            </button>
        </div>

...
<?php $component = App\View\Components\UserRoutePageName::resolve(['routeName' => 'admin.department.index'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('department-show-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3248821777-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\Users\Joshua Tabura\Desktop\computer-aided-model-system-for-student\resources\views\admin\department\index.blade.php ENDPATH**/ ?>
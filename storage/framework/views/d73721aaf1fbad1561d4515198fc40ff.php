                    ...
                    <div x-data="{ expanded: false, content: '' }" class="w-full   " >
                        <div @click="expanded = !expanded" class="rounded-[5px] p-4 bg-white  cursor-pointer hover:bg-neutral-100" :class="expanded ? 'hidden' : 'h-20'">
                            <div  class="flex items-center">
                                <a href="#" class="block">
                                    <!-- User Image Logic -->
                                    <img  src="<?php echo e($manageCourse->teacher->teacher_photo && Storage::exists('public/teacher_photos/' . $manageCourse->teacher->teacher_photo) ? asset('storage/teacher_photos/' . $manageCourse->teacher->teacher_photo) : asset('assets/img/user.png')); ?>" class="shadow-xl border-[.1px] border-gray-500 rounded-full w-9 object-contain mx-auto">
                                </a>
                                                                        ...
                                                                        <li class="mb-2 flex items-center border rounded p-2">
                                                                            ...
                                                                            <?php if($content['type_of_classwork'] === 'Practice Problem'): ?>
                                                                                ...
                                                                                <template x-if="showModal">
                                                                                    <div id="countdown<?php echo e($content['content_id']); ?>" class="text-lg font-semibold text-red-500 dark:text-red-400 mb-4"   x-show="showModal" x-data="{ timer: 3600, interval: null, expired: false }" x-init="
                                                                                    interval = setInterval(() => {
                                                                                        if (timer > 0) {
                                                                                            ...
                                                                                            document.getElementById('countdown<?php echo e($content['content_id']); ?>').innerHTML = hours + 'h ' + minutes + 'm ' + seconds + 's ';
                                                                                        } else {
                                                                                            clearInterval(interval);
                                                                                            expired = true;
                                                                                            document.getElementById('countdown<?php echo e($content['content_id']); ?>').innerHTML = 'Time\'s up!';
                
                                                                                            updateStatusToMissing(<?php echo e($content['content_id']); ?>);
                                                                                        }
                                                                                    }, 1000);
                                                                                ">
                                                                                </div>

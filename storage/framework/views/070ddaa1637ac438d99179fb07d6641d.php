                    ...
                    <div class="relative" x-cloak x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 w-48 bg-white rounded-md shadow-lg py-2 z-20 ">
                            ...
                            <form method="POST" action="<?php echo e(route('teacher.logout')); ?>">
                                <?php echo csrf_field(); ?>
                                <a href="<?php echo e(route('teacher.logout')); ?>"
...
</script><?php /**PATH C:\Users\Joshua Tabura\Desktop\computer-aided-model-system-for-student\resources\views\components\teacher\section-div-style.blade.php ENDPATH**/ ?>
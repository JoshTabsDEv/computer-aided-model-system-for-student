...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['toggleButtonId', 'sidebarContainerId', 'dashboardContentId', 'toggleIconId']));
...
foreach (array_filter((['toggleButtonId', 'sidebarContainerId', 'dashboardContentId', 'toggleIconId']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const sidebarContainer = document.getElementById('<?php echo e($sidebarContainerId); ?>');
...
</script><?php /**PATH C:\Users\Joshua Tabura\Desktop\computer-aided-model-system-for-student\resources\views\components\show-hide-sidebar.blade.php ENDPATH**/ ?>
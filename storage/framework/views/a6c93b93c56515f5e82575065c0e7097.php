...
<?php $component = App\View\Components\UserRoutePageName::resolve(['routeName' => 'teacher.teacher-courses'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2361944306-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH C:\Users\Joshua Tabura\Desktop\computer-aided-model-system-for-student\resources\views\student\courses\course_load.blade.php ENDPATH**/ ?>